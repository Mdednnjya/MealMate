                        ...
                        {user && (
                            <li className="w-full md:w-auto text-center mb-4 md:mb-0">
                                <button onClick={() => router.push('/notifications')} className="relative">
                                    ...
                                    <span
                                        className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">9</span>
                                </button>
                            </li>
                        )}
